...
function Home() {
	...
	const services = [
		...
		},
		{
			...
			link: '/servicios/gestion-logistica-local',
		},
		{
			...
			link: '/servicios/almacenaje-inteligente',
		},
		{
			...
			link: '/servicios/seguro-de-carga',
		},
	];
			...
			<main className="page">
				...
				<section className="services" id="servicios">
					...
					<div className="services__list">
						{services.map(({ title, description, image, benefits, link }, index) => (
							<article className="service-card" data-animate key={index}>
								...
								<div className="service-card__body">
									...
									<div className="service-card__actions">
										<Link to={link} className="btn ghost btn--small">
											Ver más detalles
										</Link>
										<a href="/#contacto" className="btn primary btn--small">
											Solicitar servicio
										</a>
									</div>
								</div>
